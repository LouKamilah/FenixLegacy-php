...
<aside
        ...
        <div
            ...
            <button
                ...
                <span class="group-hover:text-gray-700 select-none">Cerrar Sesión</span>
            </button>
        </div>
...
<div class="ml-auto lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
    ...
    <div class="flex items-center justify-between font-mont font-extrabold text-indigo-900 text-4xl ml-4">
        <h1 class="cursor-default select-none">CREAR CLIENTE</h1>
    ...
    <div class="grid grid-cols-2 gap-x-4 gap-y-10 pt-28 pb-8 ml-20 w-96 text-center text-white font-mont font-bold">
        ...
        <input class="w-72 rounded-xl text-black pl-4 font-medium select-none" oninput="this.value = this.value.replace(/[^A-Za-z]/g, '')" type="text" placeholder="Inserte Nombre Cliente" required name="txtNcliente">
    </div>
    ...
    <?php
        if (isset($_POST['btncrear']) && $_POST['btncrear'] == "Crear") {
            ...
            $validar = "SELECT * FROM cliente WHERE nombre_cliente = '$idcliente'";
