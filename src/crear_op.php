        ...
        if (isset($_POST['btncrear']) && $_POST['btncrear'] == "Crear") {
            ...
            if ($validando->num_rows > 0) {
                ...
                if ($turno == 0) {
                    ...
                    $insertarUno = $conexion->query("INSERT INTO login VALUES ('6', '$usuario','$contraseña','Operador')");
                    if ($insertarUno==true) {

                        $insertarDos = $conexion->query("INSERT INTO operador VALUES ('4', '$nombre','$apellido','6','$turno')");
