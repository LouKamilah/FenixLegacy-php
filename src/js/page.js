Paginador = function (divPaginador, tabla) {
  ...
  this.Mostrar = function () {
    ...
    ant.className =
      "text-center px-3 h-8 text-white bg-indigo-800 hover:bg-indigo-900 rounded-xl cursor-pointer inline-block mr-2"; //con eso le asigno un estilo y una clase al boton
    var self = this;
    ...
    num.className =
      "text-center px-3 h-8 text-white bg-indigo-800 rounded-xl cursor-default inline-block mr-2"; //con eso le asigno un estilo y una clase al boton
