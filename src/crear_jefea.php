        ...
        if (isset($_POST['btncrear']) && $_POST['btncrear'] == "Crear") {
            ...
            if ($validando->num_rows > 0) {
                echo "<script>Swal.fire({
                    ...
                    $insertarUno = $conexion->query("INSERT INTO login VALUES ('7', '$usuario','$contraseña','Jefe Area')");
                    if ($insertarUno==true) {

                        $insertarDos = $conexion->query("INSERT INTO jefe_area VALUES ('null', '$nombre','$apellido','7')");
